...
export default function MyPostListPage() {
  ...
  const filteredPosts = filter
    ? posts.filter((post) => post.state === filter)
    : posts;

  const getRouteName = (state) => {
    switch (state) {
      case "LOST": return "MissingDetailPage";
      case "SIGHT": return "WitnessDetailPage";
      default: return "DefaultDetailPage";
    }
  };
